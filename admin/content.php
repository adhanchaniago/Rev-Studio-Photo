...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
	...
	} elseif ($_GET['module'] == 'konsumenadd') {
		include "modules/daftar/view.php";
	}
	...
	} elseif ($_GET['module'] == 'edit_konsumen') {
		include "modules/konsumen/view1.php";
	}
	// ---------------------------------------------------------------------------------
	...
	elseif ($_GET['module'] == 'fifo') {
		include "modules/fifo/view.php";
	}

	// jika halaman konten yang dipilih fifo, panggil file view fifo
	elseif ($_GET['module'] == 'foto') {
		include "modules/foto/view.php";
	}
