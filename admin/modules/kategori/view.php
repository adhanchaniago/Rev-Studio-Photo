<div class="page-content">
	<div class="page-header">
		<h1 style="color:#585858">
			<i style="margin-right:7px" class="ace-icon fa fa-folder-o"></i> Kategori Paket
                            	...
                            	<tr>
									...
									<td width="80" class="center">
										<div class="action-buttons">
											...
											<a data-rel="tooltip" data-placement="top" title="Hapus" class="red tooltip-error" href="modules/kategori/proses.php?act=delete&id=<?php echo $data['id_kategori'];?>" onclick="return confirm('Anda yakin ingin menghapus kategori paket <?php echo $data['nama_kategori']; ?> ?');">
