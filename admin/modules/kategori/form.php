...
<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right">ID Kategori</label>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right">Nama Kategori Paket</label>
