...
<div class="form-group">
								<div class="col-sm-12">
									<input type="text" class="col-xs-12 col-sm-12" name="nama_produk" placeholder="ID Paket.." autocomplete="off" required />
								</div>
							</div>
							
							<div class="form-group">
								<div class="col-sm-12">
									<input type="text" class="col-xs-12 col-sm-12" name="nama_barang" placeholder="Nama Paket.." autocomplete="off" required />
								</div>
							</div>
						...
						<div class="col-xs-12 col-md-4">
							...
							<div>
								<label style="color:#478fca;font-size:14px;font-weight:bold">Paket</label>
								<div>
				...
				<form class="form-horizontal" role="form" action="modules/barang/proses.php?act=update" method="POST" enctype="multipart/form-data" />
					...
					<div class="row">
						<div style="padding-right: 40px" class="col-xs-12 col-md-8">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<input type="text" class="col-xs-12 col-sm-12" name="nama_barang" placeholder="Nama Paket.." autocomplete="off" value="<?php echo $nama_barang; ?>" required />
								</div>
							</div>
						...
						<div class="col-xs-12 col-md-4">
							...
							<div>
								<label style="color:#478fca;font-size:14px;font-weight:bold">Kategori Paket</label>
								<div>
									<select class="chosen-select" name="kategori" data-placeholder="Pilih Kategori..." required>
					...
					<div class="col-xs-12 col-sm-9">
						...
						<div style="font-size:14px" class="profile-user-info">
							<div class="profile-info-row">
								<div style="width:170px" class="profile-info-name"> Kategori Paket </div>
