<div class="page-content">
	<div class="page-header">
		<h1 style="color:#585858">
			<i class="ace-icon fa fa-folder-o"></i> Data Paket Shafa Studio
                            	...
                            	<tr>
									...
									<td width="60" class="center">
										<div class="action-buttons">
											...
											<a data-rel="tooltip" data-placement="top" title="Hapus" class="red tooltip-error" href="modules/barang/proses.php?act=delete&id=<?php echo $data['id_barang'];?>" onclick="return confirm('Anda yakin ingin menghapus paket <?php echo $data['nama_barang']; ?> ?');">
