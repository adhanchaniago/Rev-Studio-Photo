                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" action="modules/konsumen/proses.php?act=update" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="telepon" autocomplete="off" maxlength="15" onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo $telepon; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="url" autocomplete="off" value="<?php echo $url; ?>" required>
                                    </div>
                                </div>
