...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN JUMLAH PEMESANAN</title>
    ...
    <body>
        ...
        <div id="isi">
            <table width="100%" border="0.5" cellpadding="0" cellspacing="0">
                <tr class="tr-title">
                    ...
                    <th height="25" align="center" valign="middle">Nama Produk</th>
        ...
        <div id="footer-tanggal">
            Air Joman, <?php echo tgl_eng_to_ind($hari_ini); ?>
        </div>
