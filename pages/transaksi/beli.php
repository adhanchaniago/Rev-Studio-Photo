                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="POST" action="pages/transaksi/proses_beli.php" name="frmBeli">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Nama Pelaminan</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" hidden id="stok" name="stok" autocomplete="off" value="<?php echo $data['stok']; ?>" readonly hidden required>
                                        </div>
                                    </div>
