                ...
                <div class="col-md-12">
                    ...
                    elseif ($_GET['alert'] == 1) { ?>
                        <div class="alert alert-success alert-dismissible" role="alert">
                            ...
                            <strong><i class="glyphicon glyphicon-ok-circle"></i> Sukses!</strong> Pelaminan berhasil ditambahkan.
                        </div>
                    <?php
                    }
                    elseif ($_GET['alert'] == 2) { ?>
                        <div class="alert alert-success alert-dismissible" role="alert">
                            ...
                            <strong><i class="glyphicon glyphicon-ok-circle"></i> Sukses!</strong> Pelaminan berhasil dihapus.
                        </div>
                    <?php
                    }
                    ?>
                    ...
                    <?php  
                    if ($count>0) { ?>
                        <a href="?page=home" class="btn btn-primary">Lanjutkan Pesan Pelaminan</a>
                        &nbsp; &nbsp; 
                        <a href="?page=checkout" class="btn btn-primary pull-right">Selesai Pesan</a>
                    <?php
                    }
                    ?>
                    </div>
