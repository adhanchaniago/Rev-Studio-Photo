...
<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right">ID Paket</label>

						<div class="col-sm-9">
							<input type="text" class="col-xs-12 col-sm-5" name="id_kategori" autocomplete="off" required />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right">Nama Paket</label>
