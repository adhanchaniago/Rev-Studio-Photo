...
--
-- Host: localhost
-- Generation Time: Apr 07, 2020 at 12:32 PM
...
(1, 14, '2020-02-14', 'Paket Wisuda', '<p>Paket Widusa Terdiri dari beberapa jenis foto yang akan di pilih oleh member bedasarkan paket yg di pilih</p>', 1200000, 98, 0, 'Spanduk Wisuda 10R+ 1b1 s.jpg'),
(2, 15, '2020-02-17', 'Group', '<p>Pemilihan Paket Group Untuk Pengambilan Foto dalam Kelompok,<br />\r\nSeperti Foto Kelas, Dll</p>', 500000, 100, 0, 'shafa_1aa.jpg'),
(3, 16, '2020-02-17', 'Keluarga', '<p>Paket Keluarga Merupakan Paket Photo yang Diambil Berdasarkan Dari Keluarga Pelanggan,</p>', 700000, 100, 0, 'shafa_4a.jpg'),
(4, 12, '2020-02-17', 'Event', '<p>Paket Event Merupakan Paket Yang Untuk Pengambilan Foto Untuk Acara-Acara Event,</p>\r\n\r\n<p>Seperti Event Tahun Baru, Event Tour De Singkarak, Dll</p>', 3000000, 0, 1, 'shafa_3.jpg'),
(5, 13, '2020-02-17', 'Wedding', '<p>Paket Ini Disediakan Untuk Pelanggan Yang Akan Melaksanan Pernikahan.&nbsp;</p>\r\n\r\n<p>Paket Ini Terdiri dari :&nbsp;</p>\r\n\r\n<p>1. Video Cinematic Durasi 3 Menit</p>\r\n\r\n<p>2. Jumlah Photo Yang Di Cetak Sebanyak 300 / 1 Album</p>\r\n\r\n<p>3. Photo Ukuran 21R+ dan Frame 1&nbsp;</p>\r\n\r\n<p>4. Photo Ukuran 19+ dan Frame 1</p>', 5000000, 99, 0, 'shafa_1a.jpg'),
(6, 12, '2020-04-01', 'Tour De Singkarak', '<p>asdasdasd</p>', 1000000, 5, 0, 'download.jpg');
...
(1, 'Shafa Studio', '<p>Shafastudio yang merupakan penyedia jasa Fotografi, Videografi, Desain dan Percetakan yang berlokasi di Jl. Dr. M. Hatta No. 3 Pasar Baru Kec. Pauh Padang.</p>\r\n\r\n<p>Digawangi oleh kru-kru yang berpengalaman serta ditunjang dengan peralatan fotografi&amp; videografi yang lengkap dan mutakhir,kami siap memberikan pelayanan terbaik denganstyle editing terkini, guna mempersembahkan hasil karya yang kreatif, dinamis dan berkonsep MINIMALIS MODERN.</p>'),
(2, 'Cara Pemesanan', '<p>1. Klik pada tombol &#39;Pesan&#39; pada produk / paket yang ingin Anda pesan.</p>\r\n\r\n<p>2. Barang yang Anda pesan akan masuk ke dalam Keranjang Belanja. Anda dapat menentukan berapa jumlah yang akan dipesan, kemudian klik tombol &#39;Simpan&#39;.</p>\r\n\r\n<p>3. Jika sudah selesai, klik tombol &#39;Selesai Belanja&#39; maka akan tampil data pembeli beserta barang yang dibeli/dipesannya. kemudian klik tombol &#39;Proses Order&#39; maka akan tampil total pembayaran serta nomor rekening pembayaran.</p>\r\n\r\n<p>4. Apabila telah melakukan pembayaran, maka barang yang dipesan akan segera dikirimkan.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>');
...
INSERT INTO `tbl_konsumen` (`id_konsumen`, `tanggal_daftar`, `nama_konsumen`, `alamat`, `kota`, `provinsi`, `kode_pos`, `telepon`, `email`, `password`, `url`) VALUES
(30, '2020-02-27 08:01:07', 'Brilian', 'Jl. Garuda II No 10', 68, 6, '', '+62822834932', 'brilian@gmail.com', '1718854405186205720022a7769cc4f4', 'https://drive.google.com/open?id=15PLHtuUPnX2Q1XRuaFreLrVQD6jjmawp');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_konsumen_upload`
--

CREATE TABLE IF NOT EXISTS `tbl_konsumen_upload` (
  `nama` varchar(100) NOT NULL,
  `jurusan` varchar(100) NOT NULL,
  `wa` varchar(14) NOT NULL,
  `paket` varchar(20) NOT NULL,
  `fs_jw` varchar(100) NOT NULL,
  `fs_kk` varchar(50) NOT NULL,
  `fkb` varchar(50) NOT NULL,
  `fkk_jw` varchar(50) NOT NULL,
  `fkk_kk` varchar(50) NOT NULL,
  `fdt` varchar(50) NOT NULL,
  `fdo_jw` varchar(50) NOT NULL,
  `fdo_kk` varchar(50) NOT NULL,
  `dll` varchar(50) NOT NULL,
  `gambar` varchar(200) NOT NULL,
  `gambar_diamon` varchar(200) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_konsumen_upload`
--

INSERT INTO `tbl_konsumen_upload` (`nama`, `jurusan`, `wa`, `paket`, `fs_jw`, `fs_kk`, `fkb`, `fkk_jw`, `fkk_kk`, `fdt`, `fdo_jw`, `fdo_kk`, `dll`, `gambar`, `gambar_diamon`) VALUES
('Ade Saputra S.Kom, M.Kom', 'Sistem Informasi', '082283493511', 'Gold', 'FOTO SENDIRI ( Jubah Wisuda )', 'FOTO SENDIRI ( Kebaya / Kemeja )', 'FOTO KELUARGA BESAR', 'FOTO KELUARGA KANDUNG ( Jubah Wisuda )', 'FOTO KELUARGA KANDUNG ( Kebaya / Kemeja )', '', 'FOTO DENGAN ORANG TUA ( Jubah Wisuda )', 'FOTO DENGAN ORANG TUA ( Kebaya / Kemeja )', '', '', ''),
('asbd', 'amnsbd', '789', 'jshdjashdb', 'FOTO SENDIRI ( Jubah Wisuda )', 'FOTO SENDIRI ( Kebaya / Kemeja )', 'FOTO KELUARGA BESAR', '', '', '', '', '', '', '72202267_3195218127172021_3344054746322305024_o.jpg', '');
...
(58, '2020-02-17', 1, 'Mandiri Syariah', '17099401', 'Ade Saputra', 'BNI', 3000000, 'the happy.jpg', 'Pembayaran Diterima'),
(60, '2020-04-01', 3, 'Mandiri Syariah', '7108155919', 'Ade Saputra', 'BNI', 1200000, 'semen-padang-hospital2.jpg', 'Menunggu Verifikasi Pembayaran');
...
(1, '2020-02-17 08:18:48', 25, 3000000, 'Transaksi Selesai'),
(2, '2020-03-24 11:54:09', 29, 5000000, 'Menunggu Pembayaran'),
(3, '2020-04-01 21:49:48', 30, 1200000, 'Menunggu Verifikasi Pembayaran');
