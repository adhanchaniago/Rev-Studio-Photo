...
if ($_GET["page"]=="cara_beli") { ?>
  <li class="active">
      <a href="?page=cara_beli"> Cara Pesanan </a>
  </li>
<?php
}
...
if (empty($_SESSION['user_email']) && empty($_SESSION['user_password'])) { 
  ...
  if ($_GET["page"]=="keranjang") { ?>
    <li class="dropdown active">
          <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-shopping-cart"></i> Pesanan <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
              ...
              <li>
                <a href="?page=pembelian&form=view"><i class="fa fa-caret-right"></i> Daftar Pesanan</a>
              </li>
  ...
  <?php
    ...
    <li class="dropdown">
          <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-upload"></i> Upload Foto Anda <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
              <li>
                <a href="?page=wedding"><i class="fa fa-caret-right"></i> Wedding</a>
              </li>

              <li role="separator" class="divider"></li>

              <li>
                <a href="?page=pwedding"><i class="fa fa-caret-right"></i> Wisuda</a>
              </li>

              <li role="separator" class="divider"></li>

              <li>
                <a href="?page=pwedding"><i class="fa fa-caret-right"></i> Event</a>
              </li>

              <li role="separator" class="divider"></li>

              <li>
                <a href="?page=pwedding"><i class="fa fa-caret-right"></i> Group</a>
              </li>
			    <li role="separator" class="divider"></li>
    <li>
                <a href="?page=pwedding"><i class="fa fa-caret-right"></i> Keluarga</a>
              </li>
          </ul>
      </li>
	  <li class="dropdown">
          <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-shopping-cart"></i> Pemesan <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
              <li>
                <a href="?page=keranjang"><i class="fa fa-caret-right"></i> Keranjang Belanja</a>
